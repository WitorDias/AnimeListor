...
API para gerenciar animes (CRUD) com a utilização de classes para tratar excessões, testes unitarios, testes de integração, segurança utilizando autenticação em nível de memória e ferramentas como prometheus e grafana para monitoramento da api.
