...
class AnimeControllerTest {
	...
	void setUp() {
		...
		BDDMockito.when(animeService.listAllAnimes(ArgumentMatchers.any()))
			.thenReturn(animePage);
		
		BDDMockito.when(animeService.listAllAnimesNonPageable())
			.thenReturn(List.of(AnimeCreator.createAnimeValid()));
		
		BDDMockito.when(animeService.listAnimeByIdOrThrowException(ArgumentMatchers.anyLong()))
			.thenReturn(AnimeCreator.createAnimeValid());
		
		BDDMockito.when(animeService.listAnimeByName(ArgumentMatchers.anyString()))
		.thenReturn(List.of(AnimeCreator.createAnimeValid()));
		
		BDDMockito.when(animeService.saveAnime(ArgumentMatchers.any(AnimeDto.class)))
		.thenReturn(AnimeCreator.createAnimeValid());
		
		BDDMockito.doNothing().when(animeService).replaceAnime(ArgumentMatchers.any(AnimeDto.class));
